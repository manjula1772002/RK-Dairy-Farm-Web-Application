      ...
      <form className="space-y-6" onSubmit={handleSubmit(submitRegister)}>
        <div>
          ...
          <InputEl
            ...
            {...register("name")}
          />
          <FormErrorEl message={errors.name?.message} />
        </div>
        <div>
          <LabelEl htmlFor="email" required>
            Email
          </LabelEl>
          <InputEl
            id="email"
            ...
            {...register("email")}
          />
          <FormErrorEl message={errors.email?.message} />
        </div>
        <div>
          <LabelEl htmlFor="password" required>
            Password
          </LabelEl>
          <InputEl
            id="password"
            ...
            {...register("password")}
          />
          <FormErrorEl message={errors.password?.message} />
        </div>
        <div>
          <button
            type="submit"
