          ...
          <div className="grid md:grid-cols-2 gap-5">
            <div>
              ...
              <InputEl
                ...
                placeholder="Milk"
              />
              <FormErrorEl message={errors.name?.[0]} />
            </div>

            <div>
              <LabelEl htmlFor="category" required>
                Category
              </LabelEl>
              <InputEl
                id="category"
                ...
                placeholder="Dairy"
              />
              <FormErrorEl message={errors.category?.[0]} />
            </div>
          </div>

          <div>
            <LabelEl htmlFor="image" required>
              Product Image
            </LabelEl>
            ...
            <FormErrorEl message={errors.image?.[0]} />
          </div>
          ...
          <div className="space-y-4">
            ...
            {form.options.map((option, index) => (
              ...
              >
                <div className="grid md:grid-cols-2 gap-5">
                  <div>
                    <LabelEl required>Label</LabelEl>
                    <InputEl
                      value={option.label}
                      onChange={(e) =>
                        updateOption(
                  ...
                  <div>
                    <LabelEl required>Price</LabelEl>
                    <InputEl
                      type="number"
                      value={option.price}
                      onChange={(e) =>
