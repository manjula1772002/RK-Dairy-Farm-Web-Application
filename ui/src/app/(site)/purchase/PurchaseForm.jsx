      ...
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1.4fr_0.8fr]">
        <form onSubmit={handleSubmit} className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2">
            <div>
              <LabelEl htmlFor="fullName" required>Full Name</LabelEl>
              <InputEl id="fullName" name="fullName" value={address.fullName} onChange={handleChange} />
              <FormErrorEl message={errors.fullName?.[0]} />
            </div>

            <div>
              <LabelEl htmlFor="phone" required>Phone Number</LabelEl>
              <InputEl id="phone" name="phone" value={address.phone} onChange={handleChange} />
              <FormErrorEl message={errors.phone?.[0]} />
            </div>

            <div>
              <LabelEl htmlFor="houseNo">House No</LabelEl>
              <InputEl id="houseNo" name="houseNo" value={address.houseNo} onChange={handleChange} required={false} />
              <FormErrorEl message={errors.houseNo?.[0]} />
            </div>

            <div>
              <LabelEl htmlFor="pincode" required>Pincode</LabelEl>
              <InputEl id="pincode" name="pincode" value={address.pincode} onChange={handleChange} />
              <FormErrorEl message={errors.pincode?.[0]} />
            </div>

            <div className="md:col-span-2">
              <LabelEl htmlFor="street" required>Street Address</LabelEl>
              <TextAreaEl id="street" name="street" value={address.street} onChange={handleChange} required />
              <FormErrorEl message={errors.street?.[0]} />
            </div>

            <div>
              <LabelEl htmlFor="city" required>City</LabelEl>
              <InputEl id="city" name="city" value={address.city} onChange={handleChange} />
              <FormErrorEl message={errors.city?.[0]} />
            </div>

            <div>
              <LabelEl htmlFor="state" required>State</LabelEl>
              <InputEl id="state" name="state" value={address.state} onChange={handleChange} />
              <FormErrorEl message={errors.state?.[0]} />
            </div>
          </div>
